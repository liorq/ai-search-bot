...
## 4. טבלת החלטות — הכרעות **מוצעות**, ממתינות להחלטה של ליאור

מבוסס על `docs/gsc-wizard-test/RESULTS.md`. שום קוד לא נמחק עד ההחלטה.
...
| `seo_core/sources/queries.py:find_cannibalisation()` | **לשמר ולתקן** | הכלי שלהם מחזיר נתון בלי שיפוט ובלי פעולה, ולא מוסיף על השורות הגולמיות. אצלנו נדרש תיקון: "במשחק" = מיקום ונתח, לא הופעות לדף; לא להציע 301 מדף הבית; להוציא שאילתות מותג | תיקון של כ-20 שורות + בדיקות |
